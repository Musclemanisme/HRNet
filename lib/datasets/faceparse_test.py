...
class FACEPARSE_TEST(BaseDataset):
    def __init__(self,
                 root,
                 list_path,
                 num_samples=None,
        ...
        super(FACEPARSE_TEST, self).__init__(ignore_label, base_size,
    ...
    #     return image, label
    def resize_image(self, image, size):     # used for test
    ...
    def __getitem__(self, index):
        ...
        # return image.copy(), label.copy(), np.array(size), name
        return image.copy(), np.array(size), name, dir
